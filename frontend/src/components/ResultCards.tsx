          ...
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Stack direction="row" spacing={1} sx={{ mt: 0.5, flexWrap: 'wrap', gap: 1 }}>
                <Chip size="small" label={`Chegou com ${refuelInfo.arrivalTankBeforeRefuel}/8`} />
...
function buildSummaryText(r: PredictionResult): string {
  return [
    ...
    `Perfil: ${r.profile}`,
    `Tanque inicial: ${r.tankLevelStart}/8`,
    '',
    ...
    `  Cenário Econômico: ${r.fuel.arrivalTankEighths.optimistic}/8`,
    `  Operação Normal: ${r.fuel.arrivalTankEighths.medium}/8`,
    `  Condição Severa: ${r.fuel.arrivalTankEighths.pessimistic}/8`,
    '',
